  ...
  return (
    <div
      className={cn(
        ...
        filterIsApplied ? "sk-ui-border-border sk-ui-bg-bg-hover" : "sk-ui-border-accent/20 sk-ui-bg-accent/10",
      )}>
          ...
          <div className="sk-ui-relative">
            <Button
              className={cn(
                ...
                selectedChains.length > 0 && "sk-ui-border-accent/30 sk-ui-bg-accent/10",
              )}

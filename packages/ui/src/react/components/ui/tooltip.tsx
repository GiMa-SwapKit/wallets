...
const TooltipContent = ({
  ...
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      className={cn(
        "swapkit-ui-preflight sk-ui-z-50 sk-ui-overflow-hidden sk-ui-rounded-lg sk-ui-border sk-ui-border-white/[0.12] sk-ui-bg-card sk-ui-px-3 sk-ui-py-2 sk-ui-text-card-foreground sk-ui-text-sm sk-ui-font-medium sk-ui-shadow-[0_4px_20px_rgba(0,0,0,0.4)]",

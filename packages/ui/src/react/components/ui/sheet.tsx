...
const sheetVariants = cva(
  "swapkit-ui-preflight sk-ui-fixed sk-ui-z-50 sk-ui-gap-4 sk-ui-bg-background sk-ui-p-6 sk-ui-shadow-lg sk-ui-transition sk-ui-ease-in-out data-[state=open]:sk-ui-animate-in data-[state=closed]:sk-ui-animate-out data-[state=closed]:sk-ui-duration-300 data-[state=open]:sk-ui-duration-500 sk-ui-border-border",
  {

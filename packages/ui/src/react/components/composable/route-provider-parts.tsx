...
function RouteStepRow({ leg }: { leg: RouteLeg }) {
  return (
    <div className="sk-ui-flex sk-ui-min-h-10 sk-ui-flex-1 sk-ui-items-center sk-ui-gap-2 sk-ui-py-1">
      ...
      <span className="sk-ui-shrink-0 sk-ui-rounded sk-ui-bg-bg-hover sk-ui-px-1.5 sk-ui-py-0.5 sk-ui-text-[10px] sk-ui-font-medium sk-ui-uppercase sk-ui-tracking-wider sk-ui-text-muted-foreground">
        Swap Provider
      </span>
    </div>
  );

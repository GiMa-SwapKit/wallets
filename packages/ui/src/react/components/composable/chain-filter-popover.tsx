...
export function ChainFilterPopover({
  ...
  return (
    <div
      className={cn(
        "sk-ui-absolute sk-ui-right-0 sk-ui-top-[calc(100%+4px)] sk-ui-z-50 sk-ui-w-[280px] sk-ui-rounded-lg sk-ui-border sk-ui-border-border sk-ui-bg-secondary sk-ui-shadow-lg",
        className,
      )}
      ref={containerRef}>

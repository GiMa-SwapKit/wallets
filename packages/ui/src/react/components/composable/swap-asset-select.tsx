...
export function SwapAssetSelectTokenDialog({ isOutputSelect = false }: { isOutputSelect?: boolean }) {
  ...
  const { assets, filters, setFilters } = useFilteredSortedAssets({ filterBySwapTo: isOutputSelect });
      ...
      <DialogContent className="sk-ui-flex sk-ui-flex-col sm:sk-ui-h-[620px] sm:!sk-ui-max-h-[min(90svh,620px)] max-sm:!sk-ui-top-0 max-sm:!sk-ui-left-0 max-sm:!sk-ui-translate-x-0 max-sm:!sk-ui-translate-y-0 max-sm:!sk-ui-h-svh max-sm:!sk-ui-max-h-none max-sm:!sk-ui-w-svw max-sm:!sk-ui-max-w-none max-sm:!sk-ui-rounded-none max-sm:!sk-ui-border-0">
          ...
          <div className="sk-ui-relative">
            <Button
              className={cn(
                ...
                selectedNetworks.length > 0 && "sk-ui-border-accent/30 sk-ui-bg-accent/10",
              )}
          ...
          {popularChainPills.map((chain) => {
            ...
            return (
              <button
                aria-pressed={isOn}
                className={cn(
                  "sk-ui-inline-flex sk-ui-items-center sk-ui-gap-1.5 sk-ui-rounded-full sk-ui-border sk-ui-border-transparent sk-ui-px-2.5 sk-ui-py-1 sk-ui-text-xs sk-ui-font-medium sk-ui-leading-none sk-ui-transition-colors",
                  isOn
                    ? "sk-ui-border-accent/30 sk-ui-bg-accent/10 sk-ui-text-foreground"
                    : "sk-ui-bg-bg-hover sk-ui-text-muted-foreground hover:sk-ui-text-foreground",
                )}
                key={chain}
                onClick={() => {
        ...
        <div className="sk-ui--mx-6 sk-ui--mb-4 sk-ui-relative sk-ui-flex sk-ui-min-h-0 sk-ui-flex-1 sk-ui-flex-col sk-ui-overflow-auto sk-ui-px-6 sk-ui-pb-6">
          {isOutputSelect && isFetchingSwapTo && (
            <div className="sk-ui-flex sk-ui-items-center sk-ui-justify-center sk-ui-gap-2 sk-ui-py-4 sk-ui-text-muted-foreground">
...
function AssetRow({
  ...
  return (
    <Button
      ...
      variant="ghost">
      <SwapAssetItem asset={identifier} />

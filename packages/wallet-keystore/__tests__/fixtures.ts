import { Chain, EVMChains } from "@swapkit-dev/helpers";
...
export const testKeystoreAddresses: Record<(typeof KEYSTORE_SUPPORTED_CHAINS)[number], string> = {
  ...
  [Chain.Aptos]: "0x7578a5b4b7545b1233988c8ffde9405787ec23b50fb278435f95428d7e1234c0",
  [Chain.Stellar]: "GBNO35XKLLTM5G55TAPDWR2E6NDWD2UJJPJ7ZNRY6I2QIND3LSAZYGE3",
  ...
  [Chain.Cardano]:
    "addr1q9g0yfps0f6krj5c0wd5hs4hafxehnlfsq8ynaw24fwp76c390gqe88qk3qtt69lpche6srul462p5nwvhvnwemgtj3q6s37er",
};
